...
import { UserIcon, Cog8ToothIcon ,ClipboardDocumentIcon} from '@heroicons/react/24/outline';
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  // const sidebarList = isSub? chil : ParentList
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {/* <SidebarLinkGroup
                activeCondition={
                  pathname === '/panel/users' || pathname.includes('users')
                }
              >
                {(handleClick, open) => {
                  return (
